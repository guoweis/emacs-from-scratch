...
* Magic to make go work
Still to be cleaned up, but for now, at least LSP is working for Go
#+begin_src emacs-lisp
...
#+end_src
* Editing settings
** Copy region between 2 windows
This is a snippet from [[https://emacs.stackexchange.com/questions/47200/copy-paste-text-among-split-window-buffers][this]]
...
* Issues
** kubectl doesn't work fast enough, probably need hydra
